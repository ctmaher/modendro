...
#' coordinates are part of the output, so you can use faceted plots in ggplot2, for example
#' (see Examples), visually check point placement. This is particularly useful for checking pith
#' location estimates.
#'
#' The outputs of
